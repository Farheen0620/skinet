...
{
    //to redue or simplify use of .FindFirstValue.Claimtypes(claims) in AppController
    ...
    public static string GetEmail(this ClaimsPrincipal user) //this keyword is used when we want to etend soething
    {
        var email = user.FindFirstValue(ClaimTypes.Email)
            ?? throw new AuthenticationException("Email claim not found");
        return email;
        //to ensure that we don't return a null value
    }
